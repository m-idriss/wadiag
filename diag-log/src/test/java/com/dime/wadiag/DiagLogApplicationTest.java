...
class DiagLogApplicationTest {
	...
	private String getLogMessage(Environment env) throws UnknownHostException {
		...
		Logger logger = LoggerFactory.getLogger(DiagLogApplication.class);
		...
		DiagLogApplication.logMessage(env);
